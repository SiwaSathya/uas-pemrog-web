        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index-mahasiswa.php" class="nav-link active">
...
<button id="btnStart" type="button" class="btn btn-primary" data-toggle="modal" data-target="#formModal">Tambah Mahasiswa!</button>
<div class="modal fade" id="formModal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="formModalLabel">Tambah Mahasiswa</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form id="formPeminjaman" method="post" action="proces/proces-create-mahasiswa.php" >
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="text" name="nim" class="form-control" id="firstName" placeholder="221212" required>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="text" name="nama" class="form-control" id="lastName" placeholder="Doe" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="lastName" class="col-sm-6 col-form-label">
            ...
            <div class="col-sm-6">
            <select class="form-control" id="awesomeness" name="tipe-kelas" required>
          ...
          <div class="form-group row">
            <label for="awesomeness" class="col-sm-6 col-form-label">
              Jurusan</label>
            <div class="col-sm-6">
            <select class="form-control" id="awesomeness" name="jurusan" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
            <input type="radio" id="html" name="jenis-kelamin" value="Pria">
            <label for="html">Pria</label><br>
            <input type="radio" id="html" name="jenis-kelamin" value="Perempuan">
          ...
          <div class="col-12">
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $row['tipe_kelas']?></td>
                    <td><?php echo $row['jurusan']?></td>
                    <td><?php echo $row['jenis_kelamin']?></td>
                    <td>
                    <a href="#" onclick="DeleteMahasiswa('<?php echo $row['nim']; ?>')"><button type="button" class="btn btn-danger">Hapus</button></a>
                    <a href="update-form-mahasiswa.php?nim=<?php echo $row['nim']?>"><button id="btnStart" type="button" class="btn btn-warning" data-toggle="modal" data-target="#formModal1">Edit Data!</button></a> 
                    </td>
